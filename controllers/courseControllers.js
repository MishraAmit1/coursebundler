...
export const createCourse = catchAsyncError(async (req, res, next) => {
  ...
  if (!title || !description || !category || !createdBy)
    return next(new ErrorHandler("Pleasee Add all Fieldss", 400));
  const file = req.file;
...
export const getCourseLecturess = catchAsyncError(async (req, res, next) => {
...
export const delteLecture = catchAsyncError(async (req, res, next) => {
